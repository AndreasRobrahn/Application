...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    activeConversation: function activeConversation() {} // conversationsComputed(){
    //     axios
    //       .get("/conversations")
    //       .then(response => {
  ...
  mounted: function mounted() {
    this.getConversations(); // console.log($('meta[name="csrf-token"]').attr('content'))
...
var staticRenderFns = [
  function() {
    ...
    return _c(
      "div",
      { staticClass: "input-group-prepend", staticStyle: { width: "auto" } },
      [
